...
CODE = "/c" #code-davinci-002 엔진을 사용한 코딩 트리거 ex) /c
DRAW = "/p" #Image 생성기 트리거 ex) /p
TEXT = "/txt" #text-davinci-003 엔진을 활용한 문장완성 트리거 ex) /txt
#======================================================================
